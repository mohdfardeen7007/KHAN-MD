...
const { getBuffer, getGroupAdmins, participants, getRandom, h2k, isUrl, Json, runtime, sleep, fetchJson} = require('../lib/functions')
...
async (conn, mek, m, { from, participants, reply, isGroup, senderNumber, groupAdmins, participants, prefix, command }) => {
    try {
